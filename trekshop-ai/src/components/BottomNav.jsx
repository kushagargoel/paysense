...
export const BottomNav = ({ activeTab = 'home', onTabChange }) => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 h-16 flex items-center justify-around z-40 max-w-[430px] mx-auto">
...
export const AIConciergeButton = ({ onClick }) => (
  <button
    onClick={onClick}
    className="fixed bottom-24 right-4 z-50 bg-white text-gray-700 flex items-center justify-center gap-2 px-4 py-3 rounded-full shadow-xl border border-gray-200 animate-subtle-pulse transition-all active:scale-95"
  >
